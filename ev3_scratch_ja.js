...
function(ext)
{
     ...
     blocks: [
              ...
              [" ", "start: モータ %m.whichMotorPort をパワー %n で回転する",                   "startMotors",              "B+C", 100],
              [" ", "rotate: モータ %m.whichMotorPort をパワー %n で %n 度回転する %m.brakeCoast","motorDegrees",           "A", 100, 360, "brake"],
              ...
              ["w", "%m.note の音を %n ミリ秒間ならす",                                         "playTone",                 "C5", 500],
              ["w", "周波数 %n の音を %n ミリ秒間ならす",                                       "playFreq",                 "262", 500],
